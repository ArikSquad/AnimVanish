...
import eu.mikart.animvanish.AnimVanishPaper;
 ...
 * @since 1.1.0
 */
public class AnimVanishPaperAPI extends AnimVanishAPI {
	 ...
	 * @since 1.1.0
	 */
	protected AnimVanishPaperAPI(@NotNull IAnimVanish plugin) {
		super(plugin);
	}
	 ...
	 */
	@NotNull
	public static AnimVanishPaperAPI getInstance() throws NotRegisteredException {
		return (AnimVanishPaperAPI) AnimVanishAPI.getInstance();
	}
	 ...
	 */
	@ApiStatus.Internal
	public static void register(@NotNull AnimVanishPaper plugin) {
		instance = new AnimVanishPaperAPI(plugin);
	}
